<%
    ...
    if(phone==null)
    {
        response.sendRedirect("request_blood.jsp");
    }
    else
    {
%>
...
.receipt-content .footer {
  ...
  color: #969CAD; 
    ...
    <body>
        ...
        <%
        ResultSet rs=dbutil.DButil.read("SELECT * FROM `blood_request` WHERE `phone` = '"+phone+"'");
        if(rs.next())
        {}
        else{
                            ...
                            <div class="payment-info">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        ...
                                        <strong>Blood Type :</strong> <%=rs.getString(4)%> 
                                        <strong>Units :</strong> <%=rs.getString(5)%>
                                    </div>
                                </div>
                            </div>
